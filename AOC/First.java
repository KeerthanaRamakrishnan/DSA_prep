...
public class First {
    public static void main(String[] args) {
        ...
        String regex = "(one)|(two)|(three)|(four)|(five)|(six)|(seven)|(eight)|(nine)|(zero)|(1)|(2)|(3)|(4)|(5)|(6)|(7)|(8)|(9)|(0)";
        String[] split = str.split("\n");
        int count=0;
        for(String s: split){
            String[] regexes = s.split(regex);
